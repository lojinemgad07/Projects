...
namespace DataBaseProjectPawell
{
    public class DBManager
    {
        ...
        //String DB_Connection_String = @"Data Source=LAPTOP-311LT9IF;Initial Catalog=PAWell;Integrated Security=True;";
        //SqlConnection myConnection;
        static string DB_Connection_String = @"Data Source=LAPTOP-311LT9IF;Initial Catalog=PAWell;Integrated Security=True;";
        SqlConnection myConnection;
        public DBManager()
        {
